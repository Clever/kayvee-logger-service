...
import (
	...
	"github.com/Clever/kayvee-logger-service/restapi"
...
func main() {
	...
	api := operations.NewKayveeLoggerServiceAPI(swaggerSpec)
	server := restapi.NewServer(api)
	defer server.Shutdown()

	parser := flags.NewParser(server, flags.Default)
	parser.ShortDescription = `Kayvee Logger Service`
	parser.LongDescription = `Logs kayvee events.`
